...
public class List_minuman_grid extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gridminuman);
        
        Intent intent = getIntent();
        idkuliner = intent.getStringExtra("id_kuliner");
        url = alamat.URl_GET_KULINERRR;
        ...
        gridview = (GridView)findViewById(R.id.gridViewminuman);
    ...
    private void pindahPage(Model_Kuliner kulinerModel){
		...
		Intent inten = new Intent(List_minuman_grid.this, Detail_Kuliner.class);
    ...
    private void updateList() {
            ...
            Adapter_grid adapter = new Adapter_grid (getApplicationContext(), R.layout.gridminuman, kulinerListNew);
