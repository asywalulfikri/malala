...
public class List_penganan extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gridpenganan);
        ...
        gridview = (GridView)findViewById(R.id.gridViewpenganan);
    ...
    private void pindahPage(Model_Kuliner kulinerModel){
		...
		Intent inten = new Intent(List_penganan.this, Detail_Kuliner.class);
    ...
    private void updateList() {
            ...
            Adapter_grid adapter = new Adapter_grid (getApplicationContext(), R.layout.gridpenganan, kulinerListNew);
