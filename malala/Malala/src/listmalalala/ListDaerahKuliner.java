...
public class ListDaerahKuliner extends Activity {
    ...
    private void pindahPage(Model_Kuliner kulinerModel){
		...
		Intent inten = new Intent(ListDaerahKuliner.this, List_Tempat_Wisata.class);
		
		inten.putExtra("idkuliner", kulinerModel.getIdkuliner());
